...
'''Prints the name of the module at import or execution.'''
print(__name__)
...
class Blockchain:
    ...
    def __init__(self, public_key, node_id):
        ...
        self.__open_transactions = []  # __ is a way of noting a class attribute as private.
    ...
    # Note on using @property and @attribute.setter decorators:
    '''The @property decorator signals to python that we want to specify how other programs will "get" (i.e read) the 
        following attribute when it's referenced ("chain" in this example), instead of simply returning the value 
        directly. It's useful here because we want to present a list format when our self.chain is read by other programs.
        
        To control how a value is "set", we can use the @attribute.setter decorator.
        (I wish python would use a @chain.getter to make these features work more consistently)'''
